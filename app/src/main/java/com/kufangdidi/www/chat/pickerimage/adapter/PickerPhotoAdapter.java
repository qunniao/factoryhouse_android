package com.kufangdidi.www.chat.pickerimage.adapter;
...
import com.kufangdidi.www.chat.pickerimage.utils.RotateImageViewAware;
import com.kufangdidi.www.chat.pickerimage.utils.ScreenUtil;
import com.kufangdidi.www.chat.pickerimage.utils.ThumbnailsUtil;
...
public class PickerPhotoAdapter extends BaseAdapter {
	...
	public PickerPhotoAdapter(Context context, List<PhotoInfo> list, GridView gridView,
		...
		LogUtils.d("list size:"+list.size()+" isMutiMode:"+isMutiMode+" hasSelect:"+hasSelect+" maxSelectSize:"+maxSelectSize);
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		LogUtils.d("picker getview:"+position);
		if (convertView == null) {			
