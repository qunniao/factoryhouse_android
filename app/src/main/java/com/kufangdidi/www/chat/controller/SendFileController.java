...
import com.kufangdidi.www.chat.activity.SendFileActivity;
import com.kufangdidi.www.chat.activity.fragment.AudioFragment;
import com.kufangdidi.www.chat.activity.fragment.DocumentFragment;
import com.kufangdidi.www.chat.activity.fragment.ImageFragment;
import com.kufangdidi.www.chat.activity.fragment.OtherFragment;
import com.kufangdidi.www.chat.activity.fragment.VideoFragment;
import com.kufangdidi.www.chat.adapter.ViewPagerAdapter;
import com.kufangdidi.www.chat.entity.FileType;
import com.kufangdidi.www.chat.entity.UpdateSelectedStateListener;
import com.kufangdidi.www.chat.utils.BitmapLoader;
import com.kufangdidi.www.chat.view.SendFileView;
...
public class SendFileController implements View.OnClickListener, ViewPager.OnPageChangeListener,
    ...
    public SendFileController(SendFileActivity context, SendFileView view) {
        ...
        String targetId = mContext.getIntent().getStringExtra(BaseApplication.TARGET_ID);
        String targetAppKey = mContext.getIntent().getStringExtra(BaseApplication.TARGET_APP_KEY);
        long groupId = mContext.getIntent().getLongExtra(BaseApplication.GROUP_ID, 0);
        if (groupId != 0) {
            ...
            if (controller != null) {
                switch (msg.what) {
                    case SEND_FILE:
                        ...
                        intent.putExtra(BaseApplication.MsgIDs, controller.mMsgIds);
                        controller.mContext.setResult(BaseApplication.RESULT_CODE_SEND_FILE, intent);
