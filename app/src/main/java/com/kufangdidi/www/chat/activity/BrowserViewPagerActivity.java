...
import com.kufangdidi.www.chat.pickerimage.utils.AttachmentStore;
...
import com.kufangdidi.www.chat.utils.NativeImageLoader;
import com.kufangdidi.www.chat.view.ImgBrowserViewPager;
import com.kufangdidi.www.chat.view.PhotoView;
...
public class BrowserViewPagerActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        long groupId = intent.getLongExtra(BaseApplication.GROUP_ID, 0);
        String targetAppKey = intent.getStringExtra(BaseApplication.TARGET_APP_KEY);
        mMessageId = intent.getIntExtra("msgId", 0);
        if (groupId != 0) {
            mConv = JMessageClient.getGroupConversation(groupId);
        } else {
            String targetId = intent.getStringExtra(BaseApplication.TARGET_ID);
            if (targetId != null) {
...
//        }
    ...
    private void initImgPathList() {
        mMsgIdList = this.getIntent().getIntegerArrayListExtra(BaseApplication.MsgIDs);
        Message msg;
        ImageContent ic;
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            if (activity != null) {
                switch (msg.what) {
                    ...
                    case SEND_PICTURE:
                        Intent intent = new Intent();
                        intent.putExtra(BaseApplication.MsgIDs, activity.mMsgIds);
