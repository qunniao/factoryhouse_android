...
import com.kufangdidi.www.chat.pickerimage.fragment.PickerAlbumFragment;
import com.kufangdidi.www.chat.pickerimage.fragment.PickerImageFragment;
import com.kufangdidi.www.chat.pickerimage.model.AlbumInfo;
...
import com.kufangdidi.www.chat.pickerimage.utils.PickerConfig;
import com.kufangdidi.www.chat.pickerimage.utils.PickerImageLoadTool;
...
public class PickerAlbumActivity extends UIView implements PickerAlbumFragment.OnAlbumItemClickListener,
	...
	private void initUI(){
		LogUtils.d("PickerAlbumActivity initUI");
		// bottom bar
	...
	public void OnAlbumItemClick(AlbumInfo info) {
		...
		if(photoList == null){
			LogUtils.d("photolist 为空");
			return;
		}
		LogUtils.d("photolist size:"+photoList.size());
