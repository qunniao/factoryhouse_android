package com.kufangdidi.www.chat.activity.historyfile.controller;
...
import com.kufangdidi.www.chat.activity.historyfile.activity.HistoryFileActivity;
import com.kufangdidi.www.chat.activity.historyfile.fragment.AudioFileFragment;
import com.kufangdidi.www.chat.activity.historyfile.fragment.DocumentFileFragment;
import com.kufangdidi.www.chat.activity.historyfile.fragment.ImageFileFragment;
import com.kufangdidi.www.chat.activity.historyfile.fragment.OtherFileFragment;
import com.kufangdidi.www.chat.activity.historyfile.fragment.VideoFileFragment;
import com.kufangdidi.www.chat.activity.historyfile.view.HistoryFileView;
import com.kufangdidi.www.chat.adapter.ViewPagerAdapter;
import com.kufangdidi.www.chat.entity.SelectedHistoryFileListener;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.delete_file_btn:
                ...
                BaseApplication.ids.clear();
                for (Integer id : idMap.keySet()) {
                    //把即将被删除的消息添加进集合中,注意获取message的id是从map中拿出来的.
                    BaseApplication.ids.add(conversation.getMessage(idMap.get(id)));
