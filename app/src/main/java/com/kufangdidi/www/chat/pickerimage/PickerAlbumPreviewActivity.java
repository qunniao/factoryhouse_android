package com.kufangdidi.www.chat.pickerimage;
...
import com.kufangdidi.www.chat.pickerimage.adapter.PickerPreviewPagerAdapter;
import com.kufangdidi.www.chat.pickerimage.model.PhotoInfo;
import com.kufangdidi.www.chat.pickerimage.model.PickerContract;
import com.kufangdidi.www.chat.pickerimage.utils.BitmapDecoder;
import com.kufangdidi.www.chat.pickerimage.utils.Extras;
import com.kufangdidi.www.chat.pickerimage.utils.ImageUtil;
import com.kufangdidi.www.chat.pickerimage.utils.PickerUtil;
import com.kufangdidi.www.chat.pickerimage.utils.RequestCode;
import com.kufangdidi.www.chat.pickerimage.view.BaseZoomableImageView;
import com.kufangdidi.www.chat.pickerimage.view.ToolBarOptions;
import com.kufangdidi.www.chat.pickerimage.view.UIView;
import com.kufangdidi.www.chat.utils.ToastUtil;
import com.kufangdidi.www.chat.utils.imagepicker.view.ViewPagerFixed;
...
public class PickerAlbumPreviewActivity extends UIView implements OnClickListener, OnPageChangeListener {
    ...
    private void initUI() {
        LogUtils.d("PickerAlbumPreviewAvtivity initUI");
    ...
    public void setImageView(PhotoInfo info) {
        LogUtils.d("PickerAlbumPreviewAvtivity setImageView1");
        if (info == null) {
            return;
        }
        LogUtils.d("PickerAlbumPreviewAvtivity setImageView2");
        if (info.getAbsolutePath() == null) {
            return;
        }
        LogUtils.d("PickerAlbumPreviewAvtivity setImageView3");
    ...
    public void onClick(View v) {
        LogUtils.d("PickerAlbumPreviewAvtivity onclick");
