...
import com.kufangdidi.www.chat.controller.ChatItemController;
...
public class ChattingListAdapter extends BaseAdapter {
    ...
    public ChattingListAdapter(Activity context, Conversation conv, ContentLongClickListener longClickListener) {
        ...
        this.mController = new ChatItemController(ChattingListAdapter.this, mActivity, conv, mMsgList, dm.density,
                longClickListener);
        mStart = mOffset;
            ...
            */
            ...
            holder.headIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //如果是店铺就进入店铺首页
                   // UserInfo userInfo = (UserInfo) mConv.getTargetInfo();
                    String chat_object_id = userInfo.getExtra("chat_object_id");
                    String chat_object_type = userInfo.getExtra("chat_object_type");
                    LogUtils.d("chat_object_id:"+chat_object_id+"  chat_object_type:"+chat_object_type);
                    if(chat_object_type==null)return;
                    int type = Integer.valueOf(chat_object_type);
                    if(type>0){
                      //  Intent intent = new Intent(mContext,StoreHomeActivity.class);
                       // intent.putExtra("store_id", Integer.valueOf(chat_object_id));
                      //  mContext.startActivity(intent);
                    }
                }
            });
