...
public class ImagePicker {
    ...
    public void setImageFolders(List<ImageFolder> imageFolders) {
        ...
        Log.d("web","ImagePicker setImageFolders"+mCurrentImageFolderPosition+mImageFolders.size());
    }
    ...
    public ArrayList<ImageItem> getCurrentImageFolderItems() {
        Log.d("web","getCurrentImageFolderItems"+mCurrentImageFolderPosition+mImageFolders.size());
